module.exports = {
  profile: {
    ...
    photo: 'https://avatars2.githubusercontent.com/u/88818?s=300&v=4', // 300x300px
    city: 'Remote, Brazil',
  ...
  pitch: `I am an experienced software developer that cares deeply about user success and therefore business success. I have been helping businesses of diverse sectors and sizes for over 10 years. <br/><br/>  Your customers and your profit are my top priority, so I will make sure I will deliver easy to use, intuitive, fast software, always focusing on the features that bring more value to them and thus to you. <br/><br/>
You can count on me to be an asset to your business and a problem solver. I have always been a curious person, one that is not satisfied until I discover how things work. I do that by breaking things (problems) into smaller things (parts of the problem) until I get a good picture of the whole situation. And then I tackle problems and I strive to solve them in an efficient and user-friendly way. I try to build simple, clean and effective solutions, rather than making complex and fragile solutions.<br/><br/>  You can rely on me being self-managed. I have been working full-time remotely for more than 5 years, being autonomous, communicative and proactive, always reaching out and interacting with the team yet capable of deep focusing on work and being very productive.
  `,
